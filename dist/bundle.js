...
function buildDeleteConfirmationModalHtml(confirmationMessage) {
  ...
  const deleteConfirmationModalDeleteBtnHtml = (0,_htmlBuilders__WEBPACK_IMPORTED_MODULE_0__.buildInputHtml)(
    "button",
    "modal-delete-btn",
  );
  deleteConfirmationModalDeleteBtnHtml.value = "Delete";
  const deleteConfirmationModalCancelBtnHtml = (0,_htmlBuilders__WEBPACK_IMPORTED_MODULE_0__.buildInputHtml)(
    "button",
    "modal-cancel-btn",
  );
  deleteConfirmationModalCancelBtnHtml.value = "Cancel";

  const deleteConfirmationModalButtonsHtml = (0,_htmlBuilders__WEBPACK_IMPORTED_MODULE_0__.wrapHtmlElements)(
    "div",
  ...
  const deleteConfirmationModalHtml = (0,_htmlBuilders__WEBPACK_IMPORTED_MODULE_0__.wrapHtmlElements)(
    "dialog",
...
function buildPageHeaderHtml() {
  ...
  const pageHeaderHtml = (0,_htmlBuilders__WEBPACK_IMPORTED_MODULE_6__.wrapHtmlElements)(
    "header",
    headerTextHtml,
    subheaderTextHtml,
  );
...
function buildNavHeaderHtml(navHeaderText, newItemIcon, btnId) {
  ...
  const navHeaderHtml = (0,_htmlBuilders__WEBPACK_IMPORTED_MODULE_6__.wrapHtmlElements)(
    "div",
    navHeaderTextHtml,
    newItemIconHtml,
  );
...
function buildTasksNavListItemHtml(icon, text) {
  ...
  const tasksNavListItemHtml = (0,_htmlBuilders__WEBPACK_IMPORTED_MODULE_6__.wrapHtmlElements)(
    "li",
    tasksNavItemIcon,
    tasksNavItemText,
  );
...
function buildTasksNavHtml() {
  ...
  const tasksNavHtml = (0,_htmlBuilders__WEBPACK_IMPORTED_MODULE_6__.wrapHtmlElements)(
    "nav",
    tasksNavHeaderHtml,
    tasksNavListHtml,
    tasksNavSaveBtn,
...
function buildTagsNavHtml() {
  ...
  const tagsNavHtml = (0,_htmlBuilders__WEBPACK_IMPORTED_MODULE_6__.wrapHtmlElements)(
    "nav",
    tagsNavHeaderHtml,
    tagsNavListHtml,
  );
...
function buildTagsNavList(tagsNav, tagsList) {
  return (() => {
    ...
    function buildTagNavListItemHtml(
      ...
      const tagNavListItemTextHtml = (0,_htmlBuilders__WEBPACK_IMPORTED_MODULE_1__.buildTextHtml)(tag.text);
      const tagNavListItemIconHtml = (0,_htmlBuilders__WEBPACK_IMPORTED_MODULE_1__.buildIconHtml)(_img_close_circle_svg__WEBPACK_IMPORTED_MODULE_0__);
      ...
      const tagNavListItemHtml = (0,_htmlBuilders__WEBPACK_IMPORTED_MODULE_1__.wrapHtmlElements)(
        "li",
...
function buildTaskForm(task, tagsList) {
  return (() => {
    ...
    function appendChecklistItem(checklistItemToAppend) {
      ...
      const checklistItemHtml = (0,_taskFormHtmlBuilders__WEBPACK_IMPORTED_MODULE_0__.buildChecklistItemHtml)(
        checklistItemText,
...
function buildTaskTable(
  ...
  return (() => {
    ...
    const labeledUpcomingDateInputHtml = (0,_htmlBuilders__WEBPACK_IMPORTED_MODULE_1__.buildLabeledDateInputHtml)(
      UPCOMING_DATE_INPUT_LABEL_TEXT,
    );
    const upcomingDateInput =
      labeledUpcomingDateInputHtml.querySelector("input");
    upcomingDateInput.min = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(), "yyyy-MM-dd");
    ...
    function displayTasks(tasksToDisplay) {
      ...
      tasksToDisplay.forEach((task) => {
        const taskRowHtml = (0,_taskTableHtmlBuilders__WEBPACK_IMPORTED_MODULE_0__.buildTaskRowHtml)(
          task.title,
          task.shortDesc,
          task.dueDate,
        );
...
const CHECKLIST_ITEM_TEXT_INPUT_PLACEHOLDER =
  "Enter checklist item description";
...
function buildNewChecklistItemInputHtml() {
  const newChecklistItemInputHtml = (0,_htmlBuilders__WEBPACK_IMPORTED_MODULE_1__.buildInputHtml)(
    "text",
    "new-checklist-item-input",
  );
...
function buildNewTaskTagSelectHtml() {
  ...
  const newTaskTagInputDefaultOption = (0,_htmlBuilders__WEBPACK_IMPORTED_MODULE_1__.buildSelectOption)(
    TASK_TAG_SELECT_DEFAULT_OPTION_TEXT,
    "",
  );
...
function buildTaskCompletedToggleBtnHtml() {
  const taskCompletedToggleBtnHtml = (0,_htmlBuilders__WEBPACK_IMPORTED_MODULE_1__.buildInputHtml)(
    "button",
...
function buildEmptyTaskFormHtml() {
  ...
  const labeledDueDateInputHtml = (0,_htmlBuilders__WEBPACK_IMPORTED_MODULE_1__.buildLabeledDateInputHtml)(
    DUE_DATE_INPUT_LABEL_TEXT,
  );
  const titleDateHtml = (0,_htmlBuilders__WEBPACK_IMPORTED_MODULE_1__.wrapHtmlElements)(
    wrapperType,
    titleInputHtml,
    labeledDueDateInputHtml,
  );
  ...
  const taskFormButtons = (0,_htmlBuilders__WEBPACK_IMPORTED_MODULE_1__.wrapHtmlElements)(
    "div",
    taskCompletedToggleBtnHtml,
    taskDeleteBtnHtml,
  );
  taskFormButtons.id = "task-form-btns";
  const formHtml = (0,_htmlBuilders__WEBPACK_IMPORTED_MODULE_1__.wrapHtmlElements)(
    "form",
    titleDateHtml,
    shortDescHtml,
    taskTagsListWithSelectHtml,
    notesHtml,
    checklistWithInputHtml,
    taskFormButtons,
  );
  return formHtml;
}
...
function buildChecklistItemHtml(text, isChecked) {
  ...
  const newChecklistItemHtml = (0,_htmlBuilders__WEBPACK_IMPORTED_MODULE_1__.wrapHtmlElements)(
    "li",
    itemCheckBoxHtml,
    itemTextInputHtml,
    itemDeleteIconHtml,
...
function buildTaskTagListItemHtml(tagText) {
  ...
  const taskTagListItemHtml = (0,_htmlBuilders__WEBPACK_IMPORTED_MODULE_1__.wrapHtmlElements)(
    "li",
    itemTextHtml,
    itemDeleteIconHtml,
  );
...
function buildTaskRowHtml(title, shortDescText, dueDate) {
  ...
  const shortDescCellHtml = (0,_htmlBuilders__WEBPACK_IMPORTED_MODULE_0__.buildTableCellHtml)(
    shortDescText,
    "short-desc-cell",
  );
  const dueDateString = dueDate
    ? (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(dueDate, "MM/dd/yyyy")
  ...
  const taskRowHtml = (0,_htmlBuilders__WEBPACK_IMPORTED_MODULE_0__.wrapHtmlElements)(
    "tr",
    titleCellHtml,
    shortDescCellHtml,
    dueDateCellHtml,
...
function displayDeleteConfirmationModal(objectDesc, object, deleteFn) {
  const deleteConfirmationModalHtml =
    (0,_buildDeleteConfirmationModalHtml__WEBPACK_IMPORTED_MODULE_13__["default"])(objectDesc);
...
function displayTasksTable(headerText, isUpcoming, tasksToDisplay) {
  MAIN.innerHTML = "";
  const taskTable = (0,_buildTaskTable__WEBPACK_IMPORTED_MODULE_9__["default"])(headerText, isUpcoming, displayTaskForm);
...
function resolveTodayBtnClick() {
  const todayTasks = TASKS_LIST.getTasks().filter(
    (task) => (0,date_fns__WEBPACK_IMPORTED_MODULE_14__["default"])(new Date(), task.dueDate) && task.isCompleted === false,
  );
...
function resolveUpcomingBtnClick() {
  ...
  dateInput.addEventListener("change", () => {
    ...
    const upcomingTasks = TASKS_LIST.getTasks().filter(
      (task) =>
        (0,date_fns__WEBPACK_IMPORTED_MODULE_18__["default"])(task.dueDate, upcomingInterval) &&
...
function resolvePastDueBtnClick() {
  const pastDueTasks = TASKS_LIST.getTasks().filter(
    (task) => (0,date_fns__WEBPACK_IMPORTED_MODULE_19__["default"])(task.dueDate) && task.isCompleted === false,
  );
